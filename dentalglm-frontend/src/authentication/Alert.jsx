  ...
  if(alert.success) {
      ...
      <>
        ...
        >
          <div className={className}>
            <div className="border-l-4 border-green-400 bg-gray-800/60 p-4 ring-1 ring-gray-800 rounded-sm">
              <div className="flex">
                ...
                <div className="ml-auto pl-3">
                  <div className="-mx-1.5 -my-1.5">
                    <button
                      ...
                      className="inline-flex rounded-md bg-gray-800/60 p-1.5 text-green-400 hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-600 focus:ring-offset-2 focus:ring-offset-gray-50"
                    >
    ...
    return (
      <>
        ...
        >
          <div className={className}>
            <div className="border-l-4 border-red-500 bg-gray-800/60 p-4 ring-1 ring-gray-800 rounded-sm">
              <div className="flex">
                <div className="flex-shrink-0">
